...
export default function LoginPage(): React.ReactElement {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-white via-[#fafafa] to-[#f5f0ff] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[#666]">Sign in to continue creating amazing videos</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-[#ddd] accent-[#1a1a1a]" />
        ...
        <p className="text-center mt-6 text-sm text-[#666]">
          ...
          <Link href="/auth/signup" className="text-purple-600 hover:underline font-medium">Sign up free</Link>
        </p>
      </div>
    </main>
  );
