...
from app.api import youtube, ai, clips, projects, voice, video, script, media, auth, wikipedia, inshorts
...
app.include_router(inshorts.router, prefix="/api/inshorts", tags=["Inshorts"])
